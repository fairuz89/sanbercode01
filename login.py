...
class TestLogin(unittest.TestCase): 
    ...
    def test_a_success_login(self): 
        ...
        time.sleep(3)
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("fairuz02@gmail.com") # isi email
        time.sleep(1)
    ...
    def test_a_failed_login_with_empty_password(self): 
        ...
        browser.get("http://barru.pythonanywhere.com/daftar") # buka situs
        time.sleep(3)
        browser.find_element(By.XPATH,"/html/body/div/div[2]/form/input[1]").send_keys("fairuz03@gmail.com") # isi email
        time.sleep(1)
